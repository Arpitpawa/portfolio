      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            >
             I’m available for freelance projects, product collaborations, and full-time opportunities. 

If you need a reliable full-stack developer to build scalable, secure, and production-ready web applications — let’s connect.
            </motion.p>
