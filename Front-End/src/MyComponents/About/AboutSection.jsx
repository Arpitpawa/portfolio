...
export default function AboutSection() {
  ...
  I am a Full Stack Web Developer focused on building scalable, secure,
  and production-ready web applications.
</p>

<p className="text-gray-600">
  I develop complete digital products — from modern frontend interfaces 
  to backend APIs, database architecture, payment integration, 
  and deployment.
</p>

<p className="text-gray-600">
  My experience includes e-commerce platforms, QR-based booking systems, 
  automated certificate generation portals, and business-focused 
  admin dashboards.
</p>
          ...
          <div>
            ...
            >
              <h3 className="text-xl font-semibold mb-8">Tech Stack & Core Expertise</h3>
