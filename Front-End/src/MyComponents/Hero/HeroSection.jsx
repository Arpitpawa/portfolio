...
export default function HeroSection() {
  ...
  const resumeUrl =
    "https://drive.google.com/uc?export=download&id=1CcQrO3E8NhThQ92tiWPFBN5pUcvjClJt";
          ...
          <div>
            ...
            >
              <span className="text-sm font-medium tracking-wider bg-black text-white px-4 py-1.5 rounded-full">
                Full Stack Developer | Scalable Web Applications & Product
                Systems
              </span>
            </motion.div>
            ...
            >
              I design and develop high-performance websites and web
              applications for businesses, startups, and entrepreneurs. From
              modern frontend interfaces to secure backend systems and
              deployment — I handle complete product development.
            </motion.p>
  ...
  className="relative w-full h-[380px] sm:h-[450px] md:h-[380px] rounded-3xl overflow-hidden shadow-2xl"
>
