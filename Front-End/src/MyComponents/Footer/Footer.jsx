...
export default function Footer() {
  ...
  { 
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/arpit-pawa-77a448250',
    ...
    <footer className="bg-black text-white py-16 md:py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Column 1 - Brand */}
          <div>
            <h2 className="text-2xl font-bold mb-6">Arpit<span className="text-gray-400">Pawa</span></h2>
            <p className="text-gray-400 mb-6 max-w-xs">
              Building scalable web applications, product systems, and business-focused digital solutions.
            </p>
          ...
          <div className="lg:col-span-2 relative">
            <div className="glassmorphism-card p-8 rounded-2xl relative z-10 overflow-hidden">
              ...
              <h3 className="text-xl font-semibold mb-6">Let’s Build Together</h3>
              <p className="text-gray-300 mb-6">
                Have a project in mind? Let's create something amazing together.
              </p>
              <a 
                href="mailto:arpitpawa2417@gmail.com"
                className="inline-flex items-center gap-2 font-medium group mb-8"
              >
                arpitpawa2417@gmail.com
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 text-sm mb-4 md:mb-0">
            <p>© {currentYear} Arpit Pawa. All rights reserved.</p>
